...
(function ($) {
  ...
  $.fn.Page = function (options) {
    ...
    return this.each(function () {
      ...
      var dataHtml = '';
      if(opts.hasNext){
          dataHtml += '<div class="next r">' + opts.next + '</div>';
      }
      if(opts.hasLastPage){
          dataHtml += '<div class="last r">' + opts.lastPage + '</div>';
      }
          dataHtml += '<ul class="pagingUl">' + str1 + str + '</ul>';
      if(opts.hasFirstPage){
          dataHtml += '<div class="first r">' + opts.firstPage + '</div>';
      }
      if(opts.hasPrv){
          dataHtml += '<div class="prv r">' + opts.prv + '</div>';
      }
